...
{ 
    ...
    { "SMSG_SYSTEM_MESSAGE",         STATUS_NEVER,       PROCESS_INPLACE,           &Session::HandleMessage                         },
    { "CMSG_JOIN_CHANNEL",           STATUS_LOGGED,      PROCESS_THREADUNSAFE,      &Session::Handle_NULL                           },
    { "CMSG_LEAVE_CHANNEL",          STATUS_LOGGED,      PROCESS_THREADUNSAFE,      &Session::Handle_NULL                           },
    { "SMSG_CHANNEL_NOTIFY",         STATUS_NEVER,       PROCESS_INPLACE,           &Session::Handle_NULL                           },
    { "CMSG_CHANNEL_LIST",           STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_NULL                           },
    { "SMSG_CHANNEL_LIST",           STATUS_NEVER,       PROCESS_INPLACE,           &Session::Handle_NULL                           },
