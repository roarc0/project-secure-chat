...
{ 
    ...
    /*0x001*/ { "CMSG_MESSAGE",                STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_ClientSide                     },
    /*0x002*/ { "SMSG_MESSAGE",                STATUS_NEVER,       PROCESS_INPLACE,           &Session::HandleMessage                         },
    ...
    /*0x005*/ { "SMSG_CHANNEL_NOTIFY",         STATUS_NEVER,       PROCESS_INPLACE,           &Session::Handle_NULL                           },
    /*0x006*/ { "CMSG_CHANNEL_LIST",           STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_NULL                           },
    /*0x007*/ { "SMSG_CHANNEL_LIST",           STATUS_NEVER,       PROCESS_INPLACE,           &Session::Handle_NULL                           },
    ...
    /*0x015*/ { "SMSG_QUEUE_POSITION",         STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_NULL                           },
    /*0x016*/ { "CMSG_PING",                   STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_ClientSide                     },
    /*0x017*/ { "SMSG_PING",                   STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_Ping                           },
};
