...
{ 
    ...
    { "CMSG_CREATE_CHANNEL",         STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_ClientSide                     },
    { "CMSG_JOIN_CHANNEL",           STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_ClientSide                     },
    { "SMSG_JOIN_CHANNEL",           STATUS_LOGGED,      PROCESS_INPLACE,           &Session::HandleJoinChannel                     },
    { "CMSG_LEAVE_CHANNEL",          STATUS_LOGGED,      PROCESS_INPLACE,           &Session::Handle_ClientSide                     },
