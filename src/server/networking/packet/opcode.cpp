...
{ 
    ...
    { "SMSG_WHISP",                  STATUS_NEVER,       PROCESS_INPLACE,           &Session::HandleServerSide                     },
    ...
    { "SMSG_JOIN_CHANNEL",           STATUS_LOGGED,      PROCESS_THREADUNSAFE,      &Session::HandleServerSide                     },
    { "CMSG_LEAVE_CHANNEL",          STATUS_LOGGED,      PROCESS_THREADUNSAFE,      &Session::HandleLeaveChannel                   },
    { "SMSG_LEAVE_CHANNEL",          STATUS_LOGGED,      PROCESS_THREADUNSAFE,      &Session::HandleServerSide                     },
    ...
    { "CMSG_LOGIN",                  STATUS_LOGGING,     PROCESS_INPLACE,           &Session::HandleLogin                          },
