...
void network_threads::start_net_threads(command_manager *c_manager, SessionManager *s_manager, uint32 n)
{
    for (uint32 i = 0 ; i<n ; i++)
        start_net_thread(c_manager, s_manager);
}

void network_threads::start_net_thread(command_manager *c_manager, SessionManager *s_manager)
{
    pthread_t      tid;
